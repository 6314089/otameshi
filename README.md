...
本番のリポジトリは[こちら](https://github.com/6314089/Project)です．ソースコードの共有などはそちらでやりましょう．

GitHubの使い方に慣れるためのリポジトリです．
Gitの使い方などを説明しています．このリポジトリは，説明を試してみたり，適当に弄ったりするために使ってください．

以下は使い方のチュートリアル的なものです．
このリポジトリで一通り試してみるといいかもしれません．
...
##注意
GitHub上にコミットしたファイルは誰からでもアクセスできるような状況になります．一度コミットすると歴史に記録されてしまうので，**間違って重要なファイルとかをコミットしてしまわないように**注意してください．
...
本流であるデフォルトのmasterブランチは全員の出来上がったプログラムが置かれている状況にします．作業が一段落した段階でmasterに合流させるようにすることで，この**masterブランチには基本的に作業途中の中途半端なのが混ざることがない**ようにします．
...
次に作りたい作業用ブランチの名前を入力してブランチを作成を押します．**ブランチ名は他人とかぶらないようなものにした方がいい**かもしれません．自分のアカウント名などを入れておくと被らなくていいかもしれません．ここでは単純なブランチ名を使っています．
...
この**indexにステージされたものが，コミットすることでGitに保存されます**．Gitに保存したい場合は，保存したいファイルをindexにステージしてからコミットをする，と言った手順を取ることになります．
...
そこで名前の先頭には**wip**（**work in progress**）とつけて，まだ作業中であることを示しておきましょう．
...
**マージコンフリクトを起こした後，コミットを行うとそのコンフリクトを解消したものと判断**してマージを行ってくれます．
